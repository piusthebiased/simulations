...
public class Translate {
    public static void main(String[] args) {
        ...
        String[] nostd = new String[]{"Phenylalanine", "Leucine", "Isoleucine", "Methionine (Start)", "Valine", "Serine", "Proline", "Threonine", "Alanine", "Tyrosine", "Stop", "Histidine", "Glutamine", "Asparagine", "Lysine", "Aspartic Acid", "Glutamic Acid", "Cysteine", "Stop", "Tryptophan", "Arginine", "Serine", "Arginine", "Glycine"};
        ...
        int TATA = input.indexOf("TATA");
        System.out.println("Line TATA: " + TATA);
        input = input.substring(TATA + 4);

        int AUG = input.indexOf("ATG");
        System.out.println("Line AUG: " + (AUG + (TATA + 4)));
        input = input.substring(AUG);
